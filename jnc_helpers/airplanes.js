...
var Colors = {
	...
	var AirPlane = function(col) {
		...
		var matPropeller = new THREE.MeshBasicMaterial( {color: 0xffff00} );
	...
	var airplane = createPlane(0.01);
	airplane.mesh.position.y = height;
	airplane.mesh.position.x = -orbit;
