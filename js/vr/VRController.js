	...
	this.pollForChanges = function(){
		...
		buttons.forEach( function( button, i ){
			...
			if( button.isTouched !== gamepad.buttons[ i ].touched ){
				...
				if( verbosity >= 0.7 ) console.log( controllerAndButtonInfo +'touch '+ eventAction )
			...
			if( button.isPressed !== gamepad.buttons[ i ].pressed ){
				...
				//if( verbosity >= 0.7 ) console.log( controllerAndButtonInfo +'press '+ eventAction )

				controller.dispatchEvent({ type: button.name +' press '+ eventAction })
				//if( verbosity >= 0.5 ) console.log( button.name +' press '+ eventAction )
...
THREE.VRController.verbosity = 0.5//0.5 or 0.7 are good...
